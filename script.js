...
// 報告書データが用意されている建物名の一覧
// （小松住宅の報告書データが用意でき次第、ここに追加してください）
const INSPECTION_READY_BUILDINGS = ["ルミナス・スターズ"];

function showInspectionFor(buildingName) {
  ...
  if (INSPECTION_READY_BUILDINGS.includes(buildingName)) {
...
const API_URL =
  "https://script.google.com/macros/s/AKfycbzUJHuWeNVbM1d5c7KVtSI5tB9y2ZT870it74h2Z45qp2xoap5DGgh7cKLIcFt-Do8c-w/exec";
...
function renderIncome() {
  document.getElementById(
    "incomeYear"
  ).textContent = `${currentIncomeYear}年`;
